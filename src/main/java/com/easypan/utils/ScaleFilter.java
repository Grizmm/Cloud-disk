...
public class ScaleFilter {
    ...
    public static void creatCover4Video(File sourceFile,Integer width,File targetFile) {
        try {
    ...
    public static Boolean createThumbnailWidthFFmpeg(File file,int thumbnailWidth,File targetFile,Boolean delSourse){
        try {
            ...
            compressImage(file,thumbnailWidth,targetFile,delSourse);
            return true;
        }catch (Exception e){
            e.printStackTrace();
        }
