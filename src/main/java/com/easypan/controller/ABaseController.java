...
public class ABaseController {
    ...
    protected SessionShareDto getUserSessionShareFromSession(HttpSession session,String shareId){
        SessionShareDto sessionShareDto =(SessionShareDto) session.getAttribute(Constants.SESSION_SHARE_KEY+shareId);
        return sessionShareDto;
    }

     protected  <S,T>PaginationResultVO convert2PaginationVO (PaginationResultVO<S> result,Class<T> classz){
