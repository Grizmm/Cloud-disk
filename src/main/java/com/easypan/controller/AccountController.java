...
@RestController("accountrController")
...
public class AccountController extends ABaseController{
    ...
    public void checkCode(HttpServletResponse responce, HttpSession session,Integer type) throws IOException{
        ...
        vCode.write(responce.getOutputStream());
    }
    ...
    public ResponseVO qqlogin(HttpSession session , String callbackUrl) throws UnsupportedEncodingException {
        ...
        String url = String.format(appConfig.getQqUrlAuthorization(),
                appConfig.getQqAppId(), URLEncoder.encode(appConfig.getQqUrlRedirect(),"utf-8"),state);
