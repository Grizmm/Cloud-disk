...
public class UserInfoQuery extends BaseParam {
	...
	public void setQqAvatorFuzzy(String qqAvatorFuzzy){
		this.qqAvatorFuzzy = qqAvatorFuzzy;
	}

	public String getQqAvatorFuzzy(){
		return this.qqAvatorFuzzy;
	}
